...
SELECT DISTINCT B.CAT_CD, B.PRD_CD, SUBSTR(RPAD(B.CAT_CD||C.PROD_NM,'30','-------------'),1,30)NAME, B.B_NO, (B.RV_QTY)RV_QTY1, (B.RV_BAL)STK_QTY, SUM(B.RV_BAL/D.MST_PK)PETTY, (B.RV_QTY-B.RV_BAL) DIFF 
...
A.RV_DT BETWEEN '01-JAN-19' AND '31-DEC-25' AND 
B.CAT_CD>'0' AND
A.DIV_CD='&&DIV_CD' AND 
B.TYP_CD='09' AND 
A.RV_TYPE NOT IN('0')
GROUP BY B.CAT_CD,B.PRD_CD,B.CAT_CD||C.PROD_NM,B.B_NO,B.RV_QTY,B.RV_BAL
