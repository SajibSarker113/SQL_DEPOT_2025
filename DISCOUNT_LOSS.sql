...
HAVING (B.OUT_DT-A.DELI_DT)>'1'
ORDER BY A.FP_ID
/

SET LINES 145
SET PAGES 4000
COL BILL_AMNT FORMAT 99,99,999.99
COL RTN FORMAT 99,99,999.99
COL NET_SALE FORMAT 99,99,999.99


COLUMN RTN FORMAT 9,99,99,999.99
COLUMN NET_SALE FORMAT 9,99,99,999.99
